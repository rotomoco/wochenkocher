    ...
    <View style={styles.container}>
      ...
      <View style={styles.getStarted}>
        <TouchableOpacity
          ...
          onPress={() => router.push('/(drawer)/gerichte')}>
